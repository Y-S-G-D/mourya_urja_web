  ...
  return (
    <section className='bg-accent w-full h-max px-8 pt-20'>
      <div className='max-w-7xl mx-auto flex flex-col justify-center  items-center'>
        ...
        <h1 className='text-4xl md:text-6xl font-bold mb-6 font-playfair'>Why Choose Us?</h1>
             ...
             chooseUsContent.map((data:chooseUs,index:number) => {
              return (
                <div 
                  ...
                  <h1 className='text-2xl font-bold my-4 font-playfair'>{data.title}</h1>
                  <p className='text-base text-center text-gray-600 font-lora'>{data.desc}</p>
                </div>
              )
             } )
           }
