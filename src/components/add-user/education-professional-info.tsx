          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-2 gap-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage>
                      {form.formState.errors.highestEducation?.message}
                    </FormMessage>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="otherEducation">
                    ...
                    <FormControl>
                      <Input
                        id="otherEducation"
                        {...field}
                        placeholder="Enter your other educational details"
                      />
                    </FormControl>
                    <FormMessage>
                      {form.formState.errors.otherEducation?.message}
                    </FormMessage>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage>
                      {form.formState.errors.workDetails?.message}
                    </FormMessage>
                  </FormItem>
                )}
              />
