                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.residenceAddress?.address?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.residenceAddress?.locality?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.residenceAddress?.district?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.residenceAddress?.pincode?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.permanentAddress?.address?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.permanentAddress?.locality?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormMessage>
                                                {form.formState.errors.permanentAddress?.district?.message}
                                            </FormMessage>
                                        </FormItem>
                                    )}
                                />
